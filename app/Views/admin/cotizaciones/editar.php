    ...
    <main class="py-16 px-4 sm:px-6 lg:px-8">
        <div class="container mx-auto max-w-7xl">
            <div class="text-center mb-12 pt-16">
                <h1 class="text-4xl md:text-5xl font-extrabold text-gray-900 tracking-tight">Editar Cotización #<?= esc($quotation['id_cotizacion']) ?></h1>
                <p class="mt-4 text-xl text-gray-600">Ajusta los detalles de la cotización y guarda los cambios.</p>
            </div>
        </div>
        ...
        <div class="container mx-auto max-w-7xl lg:grid lg:grid-cols-3 lg:gap-12">
            <div class="lg:col-span-2">
                <div class="bg-white p-8 md:p-12 rounded-2xl shadow-xl">
                    <form id="quotation-form" action="<?= site_url('panel/cotizaciones/actualizar/' . $quotation['id_cotizacion']) ?>" method="post">
                        <?= csrf_field() ?>
                        <input type="hidden" name="id_cotizacion" value="<?= esc($quotation['id_cotizacion']) ?>">
                        ...
                        <fieldset class="mb-10">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                                <div>
                                    ...
                                    <input type="text" name="cliente_nombre" id="nombre_completo" value="<?= old('cliente_nombre', esc($quotation['cliente_nombre'])) ?>" class="w-full px-4 py-3 text-lg border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" required>
                                </div>
                                <div class="iti-container w-full">
                                    ...
                                    <input type="tel" name="cliente_whatsapp" id="whatsapp" value="<?= old('cliente_whatsapp', esc($quotation['cliente_whatsapp'])) ?>" class="w-full px-4 py-3 text-lg border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" required>
                                </div>
                            </div>
                        </fieldset>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                                <div>
                                    ...
                                    <select id="tipo_evento" name="tipo_evento" class="w-full px-4 py-3 text-lg border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" required>
                                        <option value="social" <?= old('tipo_evento', $quotation['tipo_evento']) === 'social' ? 'selected' : '' ?>>Evento Social</option>
                                        <option value="empresarial" <?= old('tipo_evento', $quotation['tipo_evento']) === 'empresarial' ? 'selected' : '' ?>>Evento Empresarial</option>
                                        <option value="otro" <?= old('tipo_evento', $quotation['tipo_evento']) === 'otro' ? 'selected' : '' ?>>Otro</option>
                                    </select>
                                </div>
                                <div id="campo_empresa" style="display: none;">
                                    ...
                                    <input type="text" name="nombre_empresa" id="nombre_empresa" value="<?= old('nombre_empresa', esc($quotation['nombre_empresa'])) ?>" class="w-full px-4 py-3 text-lg border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
                                </div>
                                <div>
                                    ...
                                    <input type="number" name="num_invitados" id="cantidad_invitados" min="15" class="w-full px-4 py-3 text-lg border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" value="<?= old('num_invitados', esc($quotation['num_invitados'])) ?>" required>
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="fecha_evento" id="fecha_evento" class="w-full px-4 py-3 text-lg border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" value="<?= old('fecha_evento', esc($quotation['fecha_evento'])) ?>" required>
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="hora_inicio" id="hora_inicio" class="w-full px-4 py-3 text-lg border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 time-picker" value="<?= old('hora_inicio', esc($quotation['hora_inicio'])) ?>" required>
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="hora_consumo" id="hora_consumo" class="w-full px-4 py-3 text-lg border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 time-picker" value="<?= old('hora_consumo', esc($quotation['hora_consumo'])) ?>" required>
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="hora_finalizacion" id="hora_finalizacion" class="w-full px-4 py-3 text-lg border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 time-picker" value="<?= old('hora_finalizacion', esc($quotation['hora_finalizacion'])) ?>" required>
                                </div>
                                <div class="md:col-span-2">
                                    ...
                                    <textarea id="direccion_evento" name="direccion_evento" rows="3" class="w-full px-4 py-3 text-lg border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder="Calle, número, colonia y referencias." required><?= old('direccion_evento', esc($quotation['direccion_evento'])) ?></textarea>
                                </div>
                            </div>
                        </fieldset>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                                <div>
                                    ...
                                    <select id="mesa_mantel" name="mesa_mantel" class="w-full px-4 py-3 text-lg border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" required>
                                        <option value="si" <?= old('mesa_mantel', $quotation['mesa_mantel']) === 'si' ? 'selected' : '' ?>>Sí</option>
                                        <option value="no" <?= old('mesa_mantel', $quotation['mesa_mantel']) === 'no' ? 'selected' : '' ?>>No</option>
                                        <option value="otro" <?= old('mesa_mantel', $quotation['mesa_mantel']) === 'otro' ? 'selected' : '' ?>>Otro (especificar)</option>
                                    </select>
                                </div>
                                <div id="campo_mesa_mantel_especificar" style="display: none;">
                                    ...
                                    <input type="text" name="mesa_mantel_especificar" id="mesa_mantel_especificar" value="<?= old('mesa_mantel_especificar', esc($quotation['mesa_mantel_especificar'])) ?>" class="w-full px-4 py-3 text-lg border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
                                </div>
                                <div>
                                    ...
                                    <select id="modalidad_servicio" name="modalidad_servicio" class="w-full px-4 py-3 text-lg border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" required>
                                        <option value="buffet_self_service" <?= old('modalidad_servicio', $quotation['modalidad_servicio']) === 'buffet_self_service' ? 'selected' : '' ?>>Buffet / Self Service (Menores a 20 personas)</option>
                                        <option value="buffet_asistido" <?= old('modalidad_servicio', $quotation['modalidad_servicio']) === 'buffet_asistido' ? 'selected' : '' ?>>Buffet asistido por staff</option>
                                        <option value="servicio_a_la_mesa" <?= old('modalidad_servicio', $quotation['modalidad_servicio']) === 'servicio_a_la_mesa' ? 'selected' : '' ?>>Servicio a la mesa</option>
                                    </select>
                                </div>
                                <div class="md:col-span-2">
                                    ...
                                    <textarea id="dificultad_montaje" name="dificultad_montaje" rows="3" class="w-full px-4 py-3 text-lg border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder="Ej: Es un 5to piso sin elevador, hay que caminar 200m, etc." required><?= old('dificultad_montaje', esc($quotation['dificultad_montaje'])) ?></textarea>
                                </div>
                                <div>
                                    ...
                                    <select id="como_nos_conocio" name="como_nos_conocio" class="w-full px-4 py-3 text-lg border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" required>
                                        <option value="recomendacion" <?= old('como_nos_conocio', $quotation['como_nos_conocio']) === 'recomendacion' ? 'selected' : '' ?>>Recomendación</option>
                                        <option value="redes" <?= old('como_nos_conocio', $quotation['como_nos_conocio']) === 'redes' ? 'selected' : '' ?>>Redes Sociales</option>
                                        <option value="restaurante" <?= old('como_nos_conocio', $quotation['como_nos_conocio']) === 'restaurante' ? 'selected' : '' ?>>Por el restaurante</option>
                                        <option value="otro" <?= old('como_nos_conocio', $quotation['como_nos_conocio']) === 'otro' ? 'selected' : '' ?>>Otro</option>
                                    </select>
                                </div>
                                <div>
                                    ...
                                    <select id="tipo_consumidores" name="tipo_consumidores" class="w-full px-4 py-3 text-lg border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" required>
                                        <option value="hombres" <?= old('tipo_consumidores', $quotation['tipo_consumidores']) === 'hombres' ? 'selected' : '' ?>>Hombres</option>
                                        <option value="mujeres" <?= old('tipo_consumidores', $quotation['tipo_consumidores']) === 'mujeres' ? 'selected' : '' ?>>Mujeres</option>
                                        <option value="ninos" <?= old('tipo_consumidores', $quotation['tipo_consumidores']) === 'ninos' ? 'selected' : '' ?>>Niños</option>
                                        <option value="mixto" <?= old('tipo_consumidores', $quotation['tipo_consumidores']) === 'mixto' ? 'selected' : '' ?>>Mixto</option>
                                    </select>
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="restricciones_alimenticias" id="restricciones_alimenticias" value="<?= old('restricciones_alimenticias', esc($quotation['restricciones_alimenticias'])) ?>" class="w-full px-4 py-3 text-lg border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder="Ej: Alergias, veganos, etc.">
                                </div>
                                <div>
                                    <label for="rango_presupuesto" class="block text-base font-semibold text-gray-800 mb-2">Rango de presupuesto (opcional)</label>
                                    <input type="text" name="rango_presupuesto" id="rango_presupuesto" value="<?= old('rango_presupuesto', esc($quotation['rango_presupuesto'])) ?>" class="w-full px-4 py-3 text-lg border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder="$5,000 - $10,000">
                                </div>
                                <div class="md:col-span-2">
                                    ...
                                    <textarea name="notas_adicionales" id="notas_adicionales" rows="3" class="w-full px-4 py-3 text-lg border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500"><?= old('notas_adicionales', esc($quotation['notas_adicionales'])) ?></textarea>
                                </div>
                            </div>
                        </fieldset>
    ...
    <script>
       ...
       // 1. Define la configuración una sola vez para todos los selectores de hora
        ...
        $(document).ready(function() {
            ...
            // --- LÓGICA PARA PRE-POBLAR EL FORMULARIO DE EDICIÓN ---
            const existingMenuDetails = <?= json_encode($quotation['detalle_menu'] ?? null) ?>;
            if (existingMenuDetails && existingMenuDetails.selection) {
                // Pre-poblar selecciones
                for (const mainId in existingMenuDetails.selection) {
                    const value = existingMenuDetails.selection[mainId];
                    if (typeof value === 'object') { // Item personalizable
                        for (const stepId in value) {
                            const selectedOptionId = value[stepId];
                             const hiddenInput = `<input type="hidden" name="menu_selection[${mainId}][${stepId}]" value="${selectedOptionId}" data-main-dish="${mainId}">`;
                             selectedItemsContainer.append(hiddenInput);
                        }
                    } else { // Item simple
                        const hiddenInput = `<input type="hidden" name="menu_selection[${mainId}]" value="${mainId}" data-item-id="${mainId}">`;
                        selectedItemsContainer.append(hiddenInput);
                    }
                }
                // Pre-poblar cantidades
                if (existingMenuDetails.quantities) {
                    for (const itemId in existingMenuDetails.quantities) {
                        const quantity = existingMenuDetails.quantities[itemId];
                         const quantityInput = `<input type="hidden" name="menu_quantities[${itemId}]" value="${quantity}" data-item-id="${itemId}">`;
                        selectedItemsContainer.append(quantityInput);
                    }
                }
                // Actualizar la cotización instantánea para mostrar los datos cargados
                updateInstantQuote();
            }
        });
