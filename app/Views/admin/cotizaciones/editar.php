...
<body class="bg-slate-50">
        ...
        <div class="container mx-auto max-w-7xl lg:grid lg:grid-cols-3 lg:gap-12">
            <div class="lg:col-span-2">
                <div class="bg-white p-8 md:p-12 rounded-2xl shadow-xl">
                    ...
                    <form id="quotation-form" action="<?= site_url(route_to('panel.cotizaciones.update')) ?>" method="post">
                        <?= csrf_field() ?>
                        <input type="hidden" name="id_cotizacion" value="<?= esc($cotizacion['id_cotizacion']) ?>">
                        ...
                        <fieldset class="mb-10">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                                <div>
                                    ...
                                    <input type="text" name="cliente_nombre" id="nombre_completo" 
                                           value="<?= old('cliente_nombre', esc($cotizacion['cliente_nombre'], 'attr')) ?>" 
                                           class="w-full px-4 py-3 text-lg border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" required>
                                </div>
                                <div class="iti-container w-full">
                                    ...
                                    <input type="tel" name="cliente_whatsapp" id="whatsapp" 
                                           value="<?= old('cliente_whatsapp', esc($cotizacion['cliente_whatsapp'], 'attr')) ?>" 
                                           class="w-full px-4 py-3 text-lg border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" required>
                                </div>
                            </div>
                        </fieldset>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                                <div>
                                    ...
                                    <select id="tipo_evento" name="tipo_evento" class="w-full px-4 py-3 text-lg border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" required>
                                        <option value="social" <?= old('tipo_evento', $cotizacion['tipo_evento']) == 'social' ? 'selected' : '' ?>>Evento Social</option>
                                        <option value="empresarial" <?= old('tipo_evento', $cotizacion['tipo_evento']) == 'empresarial' ? 'selected' : '' ?>>Evento Empresarial</option>
                                        <option value="otro" <?= old('tipo_evento', $cotizacion['tipo_evento']) == 'otro' ? 'selected' : '' ?>>Otro</option>
                                    </select>
                                </div>
                                <div id="campo_empresa" style="display: none;">
                                    ...
                                    <input type="text" name="nombre_empresa" id="nombre_empresa" 
                                           value="<?= old('nombre_empresa', esc($cotizacion['nombre_empresa'], 'attr')) ?>" 
                                           class="w-full px-4 py-3 text-lg border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
                                </div>
                                <div>
                                    ...
                                    <input type="number" name="num_invitados" id="cantidad_invitados" min="10" class="w-full px-4 py-3 text-lg border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" 
                                           value="<?= old('num_invitados', esc($cotizacion['num_invitados'], 'attr')) ?>" required>
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="fecha_evento" id="fecha_evento" class="w-full px-4 py-3 text-lg border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" 
                                           value="<?= old('fecha_evento', esc($cotizacion['fecha_evento'], 'attr')) ?>" required>
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="hora_inicio" id="hora_inicio" class="w-full px-4 py-3 text-lg border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" 
                                           value="<?= old('hora_inicio', esc($cotizacion['hora_inicio'], 'attr')) ?>" required>
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="hora_consumo" id="hora_consumo" class="w-full px-4 py-3 text-lg border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" 
                                           value="<?= old('hora_consumo', esc($cotizacion['hora_consumo'], 'attr')) ?>" required>
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="hora_finalizacion" id="hora_finalizacion" class="w-full px-4 py-3 text-lg border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" 
                                           value="<?= old('hora_finalizacion', esc($cotizacion['hora_finalizacion'], 'attr')) ?>" required>
                                </div>
                                <div class="md:col-span-2">
                                    ...
                                    <textarea id="direccion_evento" name="direccion_evento" rows="3" class="w-full px-4 py-3 text-lg border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder="Calle, número, colonia y referencias." required><?= old('direccion_evento', esc($cotizacion['direccion_evento'])) ?></textarea>
                                </div>
                            </div>
                        </fieldset>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                                <div>
                                    ...
                                    <select id="mesa_mantel" name="mesa_mantel" class="w-full px-4 py-3 text-lg border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" required>
                                        <option value="si" <?= old('mesa_mantel', $cotizacion['mesa_mantel']) == 'si' ? 'selected' : '' ?>>Sí</option>
                                        <option value="no" <?= old('mesa_mantel', $cotizacion['mesa_mantel']) == 'no' ? 'selected' : '' ?>>No</option>
                                        <option value="otro" <?= old('mesa_mantel', $cotizacion['mesa_mantel']) == 'otro' ? 'selected' : '' ?>>Otro (especificar)</option>
                                    </select>
                                </div>
                                <div id="campo_mesa_mantel_especificar" style="display: none;">
                                    ...
                                    <input type="text" name="mesa_mantel_especificar" id="mesa_mantel_especificar" value="<?= old('mesa_mantel_especificar', esc($cotizacion['mesa_mantel_especificar'], 'attr')) ?>" 
                                           class="w-full px-4 py-3 text-lg border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
                                </div>
                                <div class="md:col-span-2">
                                ...
                                <div>
                                    ...
                                    <select id="como_nos_conocio" name="como_nos_conocio" class="w-full px-4 py-3 text-lg border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" required>
                                        <option value="recomendacion" <?= old('como_nos_conocio', $cotizacion['como_nos_conocio']) == 'recomendacion' ? 'selected' : '' ?>>Recomendación</option>
                                        <option value="redes" <?= old('como_nos_conocio', $cotizacion['como_nos_conocio']) == 'redes' ? 'selected' : '' ?>>Redes Sociales</option>
                                        <option value="restaurante" <?= old('como_nos_conocio', $cotizacion['como_nos_conocio']) == 'restaurante' ? 'selected' : '' ?>>Por el restaurante</option>
                                        <option value="otro" <?= old('como_nos_conocio', $cotizacion['como_nos_conocio']) == 'otro' ? 'selected' : '' ?>>Otro</option>
                                    </select>
                                </div>
                                <div>
                                    ...
                                    <select id="tipo_consumidores" name="tipo_consumidores" class="w-full px-4 py-3 text-lg border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" required>
                                        <option value="hombres" <?= old('tipo_consumidores', $cotizacion['tipo_consumidores']) == 'hombres' ? 'selected' : '' ?>>Hombres</option>
                                        <option value="mujeres" <?= old('tipo_consumidores', $cotizacion['tipo_consumidores']) == 'mujeres' ? 'selected' : '' ?>>Mujeres</option>
                                        <option value="ninos" <?= old('tipo_consumidores', $cotizacion['tipo_consumidores']) == 'ninos' ? 'selected' : '' ?>>Niños</option>
                                        <option value="mixto" <?= old('tipo_consumidores', $cotizacion['tipo_consumidores']) == 'mixto' ? 'selected' : '' ?>>Mixto</option>
                                    </select>
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="restricciones_alimenticias" id="restricciones_alimenticias" value="<?= old('restricciones_alimenticias', esc($cotizacion['restricciones_alimenticias'], 'attr')) ?>"  class="w-full px-4 py-3 text-lg border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder="Ej: Alergias, veganos, etc.">
                                </div>
                                <div>
                                    <label for="rango_presupuesto" class="block text-base font-semibold text-gray-800 mb-2">Rango de presupuesto (opcional)</label>
                                    <input type="text" name="rango_presupuesto" id="rango_presupuesto" value="<?= old('rango_presupuesto', esc($cotizacion['rango_presupuesto'], 'attr')) ?>"  class="w-full px-4 py-3 text-lg border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder="$5,000 - $10,000">
                                </div>
                                <div class="md:col-span-2">
                                    ...
                                    <textarea name="notas_adicionales" id="notas_adicionales" rows="3" class="w-full px-4 py-3 text-lg border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500"><?= old('notas_adicionales', esc($cotizacion['notas_adicionales'])) ?></textarea>
                                </div>
                            </div>
                        </fieldset>
    ...
    <script>
        ...
        const menuInicial = <?= $menuSeleccionadoJson ?>;

        $(document).ready(function() {
            const selectedItemsContainer = $('#selected-items-container');
            
            // Verificamos que menuInicial no esté vacío
            if (menuInicial && Object.keys(menuInicial).length > 0) {
                console.log("Precargando menú seleccionado:", menuInicial);
                
                // Iteramos sobre el objeto {itemId: quantity, ...}
                for (const itemId in menuInicial) {
                    if (menuInicial.hasOwnProperty(itemId)) {
                        const quantity = menuInicial[itemId];
                        const inputName = `menu_selection[${itemId}]`;
                        
                        // Creamos el input oculto tal como lo haría la lógica de la modal
                        const hiddenInput = `<input type="hidden" name="${inputName}" value="${quantity}">`;
                        selectedItemsContainer.append(hiddenInput);
                    }
                }
                
                // 3. Una vez poblado, actualizamos la UI
                // Esta función (que ya tienes) marcará los checkboxes de Nivel 1 si tienen hijos seleccionados
                updateParentState(); 
                
                // Esta función (que ya tienes) calculará el estimado inicial
                updateInstantQuote(); 
            }

            if (fechaInput && fechasUrl) {
                const fechaActualDelEvento = "<?= esc($cotizacion['fecha_evento'] ?? '', 'attr') ?>";
                // 1. Hacemos una petición para obtener las fechas ocupadas
                fetch(fechasUrl)
                    .then(response => response.json())
                    .then(fechasOcupadas => {
                        const fechasADeshabilitar = fechasOcupadas.filter(
                            fecha => fecha !== fechaActualDelEvento
                        );
                        ...
                        flatpickr(fechaInput, {
                            ...
                            defaultDate: fechaActualDelEvento,
                            minDate: "today", // No permite seleccionar fechas pasadas
                            disable: fechasADeshabilitar,
                        });
                    })
                    .catch(error => {
            ...
            flatpickr(
                horaInicioInput, 
                {
                    ...
                    locale: "es", 
                    defaultDate: "<?= esc($cotizacion['hora_inicio'], 'attr') ?>"
                }
            );
            flatpickr(
                horaConsumoInput, 
                {
                    ...
                    minuteIncrement: 15,    // Permite seleccionar en intervalos de 15 minutos (más amigable)
                    locale: "es",
                    defaultDate: "<?= esc($cotizacion['hora_consumo'], 'attr') ?>" 
                }
            );
            flatpickr(
                horaFinalizacionInput, 
                {
                    enableTime: true,       // Esencial: Habilita la selección de hora
                    noCalendar: true,       // Esencial: Oculta el calendario, dejando solo la hora
                    dateFormat: "h:i K",      // Formato que se envía al servidor (ej: "16:30")
                    ...
                    minuteIncrement: 15,    // Permite seleccionar en intervalos de 15 minutos (más amigable)
                    locale: "es", 
                    defaultDate: "<?= esc($cotizacion['hora_finalizacion'], 'attr') ?>"
                }
            );
